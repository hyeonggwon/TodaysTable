    ...
    <div class="container py-5">
      <div class="row">
        <div class="col-lg-8"> 
          ...
          <div class="text-block" style="top: 100px;">
            ...
            <form class="form" id="booking-form" method="get" action="#" autocomplete="off">
              <div class="form-group">
                <label class="form-label" for="userName">예약자 명</label>
                <input class="form-control" name="userName" id="username" type="text" autocomplete="off" required data-msg="Please enter your email">
              </div>
              
              <div class="form-group">
                <label class="form-label" for="phoneNumber">연락처</label>
                <input class="form-control" name="phoneNumber" id="phoneNumber" type="text" placeholder="0001115678" autocomplete="off" required data-msg="Please enter your phone number" pattern="^[0-9]+$">
              </div>
              
              
              <div class="form-group">
                <label class="form-label" for="userEmail">이메일</label>
                <input class="form-control" name="userEmail" id="userEmail" type="email" placeholder="name@address.com" autocomplete="off" required data-msg="Please enter your email">
              </div>
            ...
            <hr class="my-4">
            <div class="text-left">
              <p><i class="fa fa-heart"></i>&nbsp;매장 정보</p>
            ...
            <div class="custom-control custom-checkbox">
                  ...
                  <label class="custom-control-label" for="select_userInfo_0"> <p class="text-sm text-muted">개인정보 수집 동의</p> </label>
                  
            </div>

            <div class="custom-control custom-checkbox">
                  <input class="custom-control-input" id="select_userInfo_1" type="checkbox">
                  <label class="custom-control-label" for="select_userInfo_1"> <p class="text-sm text-muted">개인정보 제공 동의</p></label>
          ...
          <div class="text-block" style="top: 100px;">
          <br><br>
          <span class="text-primary h3">객실 선택</span>
            <hr class="my-4">
            <form class="form" id="booking-form" method="get" action="#" autocomplete="off">
							<div class="list-group shadow mb-5">
								<div class="list-group-item list-group-item-action p-3">
									<div class="row">
										<div
											class="col-2 col-lg-1 align-self-lg-center py-3 d-flex align-items-lg-center">
											<div class="custom-control custom-checkbox">
												<input class="custom-control-input" id="select_message_0"
													type="checkbox"> <label
													class="custom-control-label" for="select_message_0">
												</label>
											</div>
										</div>
								...
								<div class="list-group-item list-group-item-action p-4">
									<div class="row">
										<div
											class="col-2 col-lg-1 align-self-lg-center py-3 d-flex align-items-lg-center">
											<div class="custom-control custom-checkbox">
												<input class="custom-control-input" id="select_message_1"
													type="checkbox"> <label
													class="custom-control-label" for="select_message_1">
												</label>
											</div>
										</div>
										<div class="col-9 col-lg-4 align-self-center mb-3 mb-lg-0">
								...
								<div class="list-group-item list-group-item-action p-4">
									<div class="row">
										<div
											class="col-2 col-lg-1 align-self-lg-center py-3 d-flex align-items-lg-center">
											<div class="custom-control custom-checkbox">
												<input class="custom-control-input" id="select_message_2"
													type="checkbox"> <label
													class="custom-control-label" for="select_message_2">
												</label>
											</div>
										</div>
										<div class="col-9 col-lg-4 align-self-center mb-3 mb-lg-0">
								...
								<div class="list-group-item list-group-item-action p-4">
									<div class="row">
										<div
											class="col-2 col-lg-1 align-self-lg-center py-3 d-flex align-items-lg-center">
											<div class="custom-control custom-checkbox">
												<input class="custom-control-input" id="select_message_3"
													type="checkbox"> <label
													class="custom-control-label" for="select_message_3">
												</label>
											</div>
										</div>
										<div class="col-9 col-lg-4 align-self-center mb-3 mb-lg-0">
								...
								<div class="list-group-item list-group-item-action p-4">
									<div class="row">
										<div
											class="col-2 col-lg-1 align-self-lg-center py-3 d-flex align-items-lg-center">
											<div class="custom-control custom-checkbox">
												<input class="custom-control-input" id="select_message_4"
													type="checkbox"> <label
													class="custom-control-label" for="select_message_4">
												</label>
											</div>
										</div>
										<div class="col-9 col-lg-4 align-self-center mb-3 mb-lg-0">
        ...
        <div class="col-lg-4">
          <div class="p-4 shadow ml-lg-4 rounded sticky-top" style="top: 100px;">
            ...
            <form class="form" id="booking-form" method="get" action="#" autocomplete="off">
              ...
              <div class="form-group">
                <label class="form-label" for="guest_Number">인원 수</label>
                <input class="form-control" name="guest_Number" id="guest_Number" type="number" placeholder="0" autocomplete="off" required data-msg="Please enter your capacity" pattern="^[0-9]+$">
              </div>
              	<label class="form-label" for="time">시간 선택</label>
